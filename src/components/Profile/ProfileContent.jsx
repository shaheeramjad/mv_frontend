        ...
        <>
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <input
                className={`w-[250px] h-[40px] border border-[#f05518] text-center text-[#f05518] rounded-[3px] mt-8 cursor-pointer`}
                required
                value="Update"
                type="submit"
              />
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className=" w-[100%] md:w-[50%] mt-2">
            ...
            />
            <input
              className={`w-[95%] h-[40px] border border-[#f05518] text-center text-[#f05518] rounded-[3px] mt-8 cursor-pointer`}
              required
              value="Update"
              type="submit"
            />
