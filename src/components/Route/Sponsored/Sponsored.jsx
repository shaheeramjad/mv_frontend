  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/LG_logo_%282014%29.svg/250px-LG_logo_%282014%29.svg.png"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/a/ad/Dawlance_logo_%282024%29.png"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
